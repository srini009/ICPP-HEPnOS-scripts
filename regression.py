...
def model():
	pid = "6249"
	bake_eager_write_size = open("/home/srinivasan/Documents/MOCHI/hist/benchmark_bake/bake_eager_write_size_"+pid+"_0","r")
	bake_eager_write_latency = open("/home/srinivasan/Documents/MOCHI/hist/benchmark_bake/bake_eager_write_latency_"+pid+"_0","r")
	bake_write_size = open("/home/srinivasan/Documents/MOCHI/hist/benchmark_bake/bake_write_size_"+pid+"_0","r")
	bake_write_latency = open("/home/srinivasan/Documents/MOCHI/hist/benchmark_bake/bake_write_latency_"+pid+"_0","r")
